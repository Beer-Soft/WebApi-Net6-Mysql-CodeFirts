...
<template>
  ...
  >
    ...
    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1">Catalogosxx</p>
      <div
      ...
      >
        ...
        <span class="text-gray-700">
          <router-link to="/dashboard/Categoria"> Dashboard </router-link></span
        >
      </div>
      <div
